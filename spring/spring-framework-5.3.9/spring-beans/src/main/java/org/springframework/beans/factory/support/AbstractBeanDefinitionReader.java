...
/**
 * 为 BeanDefinitionReader接口的抽象实现类，实现了EnvironmentCapable，提供了获取/设置环境的方法
 * <p>
...
public abstract class AbstractBeanDefinitionReader implements BeanDefinitionReader, EnvironmentCapable {
	...
	public int loadBeanDefinitions(Resource... resources) throws BeanDefinitionStoreException {
		...
		int count = 0;
		// 循环调用父类的loadBeanDefinitions方法，走不同的子类实现
	...
	public int loadBeanDefinitions(String location, @Nullable Set<Resource> actualResources)
		...
		if (resourceLoader instanceof ResourcePatternResolver) {
			...
			try {
				// 根据资源路径调用ResourcePatternResolver的getResources方法加载多个资源
			...
			// 调用父类的loadBeanDefinitions，走不同的子类实现
