...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/**
	 * BeanDefinitionHolder储存Bean的名称、别名和BeanDefinition
	 */
	@Nullable
	...
	/**
	 * 表明已经应用了MergedBeanDefinitionPostProcessor
	 * <p>
	...
	/**
	 * DisposableBean的 destroy回调函数名destroy会在这里记录，以便进行生命周期回调
	 */
	@Nullable
	...
	/**
	 * RootBeanDefiniiton是没有父BeanDefinition的
	 */
	@Override
